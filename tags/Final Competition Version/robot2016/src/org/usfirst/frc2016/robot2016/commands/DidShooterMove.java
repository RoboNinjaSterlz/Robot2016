...
public class DidShooterMove extends Command {
    ...
    public DidShooterMove(double delaySeconds) {
    ...
    protected void initialize() {
    	didItMove = Robot.shootElevator.shooterMoved();
    ...
    protected boolean isFinished() {
    	if (!didItMove)
    		return true;
        if (waitCounter >= (int)(m_delaySeconds/DELAYPERCOUNT)) {
    		return true;
    	}
        return false;
    }
