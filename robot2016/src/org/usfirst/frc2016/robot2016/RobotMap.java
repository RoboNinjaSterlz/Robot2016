...
public class RobotMap {
    ...
    public static Servo liftReleaseReleaseServo;
    public static SpeedController flashlightFlashlightSpark;
    public static SpeedController winchWinchSpark;
    public static Solenoid stingerStingerSolenoid;
    ...
    public static void init() {
        ...
        liftReleaseReleaseServo = new Servo(8);
        LiveWindow.addActuator("LiftRelease", "ReleaseServo", liftReleaseReleaseServo);
        
        flashlightFlashlightSpark = new Spark(4);
        LiveWindow.addActuator("Flashlight", "FlashlightSpark", (Spark) flashlightFlashlightSpark);
        
        winchWinchSpark = new Spark(5);
        LiveWindow.addActuator("Winch", "WinchSpark", (Spark) winchWinchSpark);
        
        stingerStingerSolenoid = new Solenoid(0, 2);
        LiveWindow.addActuator("Stinger", "StingerSolenoid", stingerStingerSolenoid);
