...
public class OI {
    ...
    public JoystickButton incrementShooterButton;
    public JoystickButton decrementShooterButton;
    ...
    public OI() {
        ...
        decrementShooterButton = new JoystickButton(driveLeft, 7);
        decrementShooterButton.whenPressed(new DecrementShooterLift());
        incrementShooterButton = new JoystickButton(driveLeft, 6);
        incrementShooterButton.whenPressed(new IncrementShooterLift());
        ...
        SmartDashboard.putData("AutoDrawbridge1", new AutoDrawbridge1());
