...
public class OI {
    ...
    public OI() {
        ...
        kenArmLift = new JoystickButton(driveRight, 2);
        kenArmLift.whenPressed(new Robot2HookDeploy());
        ...
        flashlightOffButton = new JoystickButton(driveLeft, 7);
        flashlightOffButton.whenPressed(new FlashlightOff());
        ...
        SmartDashboard.putData("CameraDrive: Default", new CameraDrive(177, 65));
        SmartDashboard.putData("RaiseKenHook", new RaiseKenHook());
        SmartDashboard.putData("Robot2HookDeploy", new Robot2HookDeploy());
        SmartDashboard.putData("RaiseAntenna", new RaiseAntenna());
        SmartDashboard.putData("LowerAntenna", new LowerAntenna());
