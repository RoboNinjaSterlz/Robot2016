...
public class OI {
    ...
    public OI() {
        ...
        driveStraightButtonDone = new JoystickButton(driveLeft, 7);
        driveStraightButtonDone.whenReleased(new TankDrive());
        driveStraightButton = new JoystickButton(driveLeft, 7);
        ...
        SmartDashboard.putData("CompDeployHook", new CompDeployHook());
